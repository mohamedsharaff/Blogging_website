        ...
        <div class="col-10"> <br><br>
            ...
            <?php              
                ...
                include '../Admin/DBconnection.php';
                            ...
                            $create_post_query  =   "INSERT INTO `post` (`post_id`, `post_title`, `post_author`, `post_date`, `post_content`, `post_image`, `post_tag`, `post_category_id`, `post_comment_count`, `post_status`) VALUES (NULL, '$post_title', '$session_username', now(), '$post_content', '$post_image', '$post_tag', '$post_category', '$post_comment', '$post_status')";
    ...
    ?>
            ...
            <div class="form-outline">
                ...
                <form action="" class="form" method="post" enctype="multipart/form-data">
                    ...
                    <!-- text area  -->
                    <textarea placeholder="Contant" name="content" name="" id="editor"
