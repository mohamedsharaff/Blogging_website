  ...
  $quary  = "INSERT INTO `news` (`ID`, `Title`, `Date`, `Description`, `Location`, `Website`, `Contact No`) VALUES (NULL, '$Title', current_timestamp(), '$Description', '$Location', '$Website', '$Contact')";
...
<link rel="stylesheet" href="NewsPost.CSS">
