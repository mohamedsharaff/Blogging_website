    ...
    <div class="background">
        ...
        <div class="shape"></div>
            ...
            session_start();
              ...
              $admin_query = "SELECT * FROM users WHERE (user_username = '$input_username' or user_email = '$input_username') AND user_password = '$input_password' AND user_role = 'admin' ";
              $admin_result = mysqli_query($conn,$admin_query);

              $user_query = "SELECT * FROM users WHERE (user_username = '$input_username' or user_email = '$input_username') AND user_password = '$input_password' ";
              ...
              if ($admin_row > 0) {
                  ...
                  $_SESSION['session_username'] = $admin_row['user_username'];
                  $_SESSION['session_userid'] = $admin_row['user_id'];
                  $_SESSION['session_user_role'] = $admin_row['user_role'];                 
                  $_SESSION['session_user_email'] = $admin_row['user_email'];  
                  ...
                  $_SESSION['session_username'] = $user_row['user_username'];
                  $_SESSION['session_userid'] = $user_row['user_id'];
                  $_SESSION['session_user_role'] = $user_row['user_role'];                 
                  $_SESSION['session_user_email'] = $user_row['user_email'];
